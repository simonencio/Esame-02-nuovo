...
<body>
    ...
    <main>
        ...
        <section class="fotolavori">
            ...
            <div class="card">
                <h4>PORTFOLIO</h4>
            <a href="./portfolio.php" target="_blank"><img src="./immagini/portfolio.jpg" alt="portfolio" title="portfolio"></a>
            </div>
            <div class="card">
                <h4>CONTATTI</h4>
            <a href="./contatti.php" target="_blank"><img src="./immagini/contattaci.jpg" alt="contatti" title="contatti"></a>
            </div>
        </section>
    </main>
